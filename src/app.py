...
activities = {
    ...
    "Swimming Team": {
        "description": "Swim training and competitive meets across all strokes",
    ...
    "Art Workshop": {
        "description": "Explore painting, drawing, and mixed-media visual arts",
    ...
    "Debate Team": {
        "description": "Research, argue, and refine public speaking on current topics",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 16,
